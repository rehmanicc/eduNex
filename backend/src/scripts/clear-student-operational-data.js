...
async function main() {
  ...
  if (!process.argv.includes(YES)) {
    console.log('');
    console.log('============================================================');
    console.log(' STUDENT OPERATIONAL DATA RESET - PREVIEW ONLY');
    console.log('============================================================');
    console.log('');
    console.log('This script clears student-related operational data for ONE college.');
    console.log('');
    ...
    console.log('  - Student fee plans, vouchers/postings, payments, concessions/invoices');
    ...
    console.log('  - Student/admission/fee numbering sequences');
    ...
    console.log('  - Fee heads, fee structures and reusable fee packages');
  ...
  console.log('');
  console.log('============================================================');
  console.log(' STUDENT OPERATIONAL DATA RESET COMPLETE');
  console.log('============================================================');
